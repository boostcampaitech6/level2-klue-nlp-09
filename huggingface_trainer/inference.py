...
def main(args):
  ...
  ## load test datset
  test_dataset_dir = "data/test_data.csv" # ****** 여기에 테스트 데이터 좌표 입력 ******
  ...
  output.to_csv('KSW/result_csv/result_240115.csv', index=False) # 최종적으로 완성된 예측한 라벨 csv 파일 형태로 저장.
  #### 필수!! ##############################################
  print('---- Finish! ----')
if __name__ == '__main__':
  ...
  # model dir
  parser.add_argument('--model_dir', type=str, default="KSW/best_model/240115") # ****** 여기에 모델 위치 입력 model.save_pretrained() 그대로 입력 ******
